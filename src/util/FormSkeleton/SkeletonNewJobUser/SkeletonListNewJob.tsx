      ...
      <div className="flex justify-center">
        <ul className="inline-flex flex-wrap justify-center list-job gap-5 w-full">
          <div className="relative">
            <div
              className={`w-[370px] h-fit group gap-x-2  px-4 border-[1px]  transition-all duration-500   bg-white  rounded-md  py-6 flex justify-between items-center item-job`}
            >
...
export default SkeletonListNewJob;
