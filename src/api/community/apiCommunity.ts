...
const communityApi = {
  postCommunications: (newCommunity: FormCommunity) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications`;
  ...
  deleteComent: (postId: any, cmtId: any) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communication-comments/${postId}/${cmtId}`;
  ...
  getCommunitations: (
    ...
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications?page=${page}&limit=${limit}&sort=${sort}&type=${type}`;
  ...
  getCommunityNews: (
    ...
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/news?page=${page}&limit=${limit}&sort=${sort}&type=${type}&lang=${lang}`;
    return axiosClient.get(URL);
  },
  ...
  getCommunityWorkingStory: () => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/working-story`;
    return axiosClient.get(URL);
  },
  ...
  getCommunityTodayByAccount: (page: string, limit: string, sort: string) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/today/by-account?page=${page}&limit=${limit}&sort=${sort}`;
    return axiosClient.get(URL, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
      },
  ...
  getCommunityByAccount: (
    ...
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/by-account?page=${page}&limit=${limit}&sort=${sort}&lang=${lang}`;
    return axiosClient.get(URL, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
      },
  ...
  putCommunityByAccount: (id: number, putCommunity: any) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/${id}`;
  ...
  getCommunityToday: (page: string, limit: string, sort: string) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/today?page=${page}&limit=${limit}&sort=${sort}`;
    return axiosClient.get(URL);
  },

  getCommunityShareId: (id: string) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/share/${id}`;
    return axiosClient.get(URL, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
      },
  ...
  getCommunityDetailId: (id: string, lang: any) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/detail/${id}?lang=${lang}`;
    return axiosClient.get(URL);
  },
  ...
  postCommunityByAdmin: (newCommunityAdmin: FormCommunity) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/by-admin`;
  ...
  putCommunityByAdmin: (id: number, newCommunityAdmin: FormPutCommunity) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communications/by-admin/${id}`;
  ...
  postCommunityLike: (communicationId: number) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communication-likes`;
  ...
  getCommunityLike: (id: string) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communication-likes/${id}`;
    return axiosClient.get(URL, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
      },
  ...
  postCommunityComment: (newCommentCommunity: FormPostCommunityComment) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communication-comments`;
    return axiosClient.post(URL, newCommentCommunity, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
        'Content-Type': 'multipart/form-data',
  ...
  getCommunityComment: (id: string) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communication-comments/${id}`;
    return axiosClient.get(URL, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
      },
  ...
  putCommunityComment: (
    ...
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communication-comments/${communicationId}/${commentId}`;
  ...
  postCommunityBookmarked: (communicationId: number) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communication-bookmarked`;
    return axiosClient.post(
      URL,
      {
        communicationId: communicationId,
  ...
  getCommunityBookmarkedRecruiter: (page: number) => {
    const URL = `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/communication-bookmarked?page=${page}`;
    return axiosClientRecruiter.get(URL, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('accessTokenRecruiter')}`,
      },
