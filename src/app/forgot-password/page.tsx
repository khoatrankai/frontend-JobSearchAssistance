      ...
      >
        ...
        >
          <div className="header mb-6 flex flex-col gap-1">
            ...
            {success && (
              <p className="text-green-700 text-sm bg-slate-200 p-3 font-bold">
          ...
          <div className="login">
            ...
            <div className="flex mt-4 align-top">
              <p className="ml-2 basic agreement-social-login">
                Bằng việc thực hiện đổi mật khẩu, bạn đã đồng ý với Điều khoản
            ...
            <div className="mt-3 gap-1 text-center flex flex-col">
              <p className="basic">Bạn gặp khó khăn khi tạo tài khoản?</p>
              <p className="basic">
