            ...
            {profileV3 && (
                <div className="flex flex-col">
                    <div className="flex justify-center items-center gap-5">
                        <img src="https://res.cloudinary.com/ddwjnjssj/image/upload/v1710091250/images/icons/c7h6nxdlxwkqjlpcjov8.png" alt="verify-success" className="w-1/4" />
                        <div className="flex flex-col gap-2">
                            <div className="text-3xl font-bold">Xác thực email không thành công</div>
