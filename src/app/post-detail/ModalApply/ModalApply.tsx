...
const Page = (prop: Prop) => {
    ...
    return (
        <div>
            <Modal className="container-apply" open={prop.openModalApply} onOk={handleOk} onCancel={handleCancel} footer={null} closeIcon={null}>
                <div style={{
                    display: 'flex',
                    justifyContent: 'center',
                    flexDirection: 'column'
                }}>
                    <h1>Ứng tuyển <span style={{
                        color: 'blue',
                        fontWeight: 'bold'
                    }}>{prop.namePost}</span></h1>
                    <div style={{
                        display: 'flex',
                        marginTop: '20px',
                        gap: '10px',
