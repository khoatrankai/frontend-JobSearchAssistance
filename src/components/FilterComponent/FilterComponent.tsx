...
const FilterComponent = (props: Props) => {
  ...
  return (
    <div
      ...
      ref={ref_filter}
    >
      <div className="relative flex flex-1 w-full p-1.5 h-12 max-w-6xl bg-white border-black/30  border-[1px] border-opacity-40 rounded-2xl pr-4 focus-within:transition-all focus-within:shadow-gray-300 focus-within:border-opacity-70">
      ...
      >
        ...
        >
          <button
            className="py-2 px-4 rounded-xl h-12 w-full bg-white border-2 text-blue-500 hover:text-white hover:shadow-[0px_0px_15px_9px_#00000024] hover:bg-blue-500 border-blue-500 hover:font-bold"
            onClick={() => {
              handleSearch();
            }}
          >
          ...
          <button
            onClick={handleReset}
            className="py-2 px-4  h-12 rounded-xl w-full bg-blue-500 border-2 text-white border-black/20 border-blue-500 hover:shadow-[0px_0px_15px_9px_#00000024] hover:bg-white hover:text-blue-500 hover:font-bold"
          >
