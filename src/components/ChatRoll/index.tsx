...
const ChatRoll: React.FC = () => {
  ...
  const handleChatBot = async () => {
    // const data: any = await axios.pó("https://jeffrey-diverse-writers-vsnet.trycloudflare.com/aiJob/");
    // //console.log(data);
    const dataVip: any = await axiosClient.post(
      "https://jeffrey-diverse-writers-vsnet.trycloudflare.com/aiChat/",
      {
        id: idChat.toString(),
  ...
  const handleCreateAI = async () => {
    const dataId = await axiosClient.post(
      "https://jeffrey-diverse-writers-vsnet.trycloudflare.com/aiStartChat/"
    );
    console.log(dataId);
    if (dataId) {
