...
const TypeAchivement = (props: Props) => {
      ...
      {data?.moreCvExtraInformations.map((dt: any, i: any) => {
        return (
          <div className="relative">
            <div
              className={`flex flex-col gap-1 w-full p-1 border-[1px] hover:border-dashed focus-within:border-black hover:border-black ${
