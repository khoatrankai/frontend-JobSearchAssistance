        ...
        {data?.moreCvExtraInformations?.map((dt: any, i: any) => {
          return (
            <li className=" relative">
              <div
                className={`pl-8 pr-4 flex flex-col gap-y-2  hover:border-black border-[1px] border-dashed ${
              ...
              >
                <div className="flex gap-x-3">
                  <input
                    ...
                    className="font-medium flex-1 bg-transparent text-xs outline-none border-[1px] border-transparent hover:border-black/30 focus-within:border-transparent focus-within:hover:border-transparent p-1 border-dashed "
