...
const ComunityCreatePostRecruiter = ({ setTab }: any) => {
  ...
  const updateCommunity = async (formData: any) => {
    ...
    try {
      if (checkForm) {
        const result = await apiCommunity.putCommunityByAccountRecruiter(
  ...
  const createCommunity = async (formData: any) => {
    ...
    try {
      if (checkForm) {
        const result = await apiCommunity.postCommunicationsRecruiter(formData);
...
export default ComunityCreatePostRecruiter;
