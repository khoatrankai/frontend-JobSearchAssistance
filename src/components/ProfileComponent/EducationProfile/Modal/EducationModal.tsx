  ...
  const handleUpdateData = async () => {
    if (type === "add") {
      const res = (await axiosClient.put(
        "https://imagination-trusted-joyce-techniques.trycloudflare.com/api/v1/profiles/edu/c",
        dataRequest
      ...
      const res = (await axiosClient.put(
        "https://imagination-trusted-joyce-techniques.trycloudflare.com/api/v1/profiles/edu/u",
        dataRequest
      )) as unknown as IResquest;
      if (res && res.code === 200) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = (await axiosClient.get(
        "https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/academic-types"
      )) as unknown as IData;
