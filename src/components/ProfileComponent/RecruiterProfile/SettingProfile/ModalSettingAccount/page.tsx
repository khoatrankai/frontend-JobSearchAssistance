...
const ModalSettingAccount = (prop: Prop) => {
  ...
  const [isCheckNewPasswordSetting, setIsCheckNewPasswordSetting] =
    useState(false);
      ...
      <div className="flex flex-col">
        <div className="flex flex-col gap-3">
          <div>
            ...
            <Input value={profileV3?.email} disabled />
          </div>
          <div>
            <div className="flex gap-1 items-center mb-3">
              <div className="flex gap-1 items-center">
            ...
            />
            {isCheckCurrentPassword && currentPassword === "" ? (
          ...
          <div>
            ...
            />
            {isCheckNewPasswordSetting && newPasswordSetting === "" ? (
              <div className="text-red-500 text-[13px] mt-2">
        ...
        <div className="flex gap-2 mt-3 justify-end">
          <div className="flex justify-end">
            <Button
              ...
              onClick={handleOkSettingAccount}
            >
              Lưu
            </Button>
          </div>
          ...
          <div className="flex justify-end">
            <Button
              ...
              className="rounded-lg"
              onClick={handleCancelSettingAccount}
            >
              Hủy
            </Button>
          </div>
