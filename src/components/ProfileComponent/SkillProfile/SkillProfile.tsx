...
const SkillProfile = (props: Props) => {
  ...
  const fetchUpdata = async (dt: any) => {
    ...
    if (dt.api) {
      const resUp = (await axiosClient.put(
        `https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/profiles-skills/${dt.id}`,
  ...
  const fetchCreatedata = async (dt: any) => {
    const resUp = (await axiosClient.post(
      "https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/profiles-skills",
      dt,
      {
        headers: {
    ...
    const fetchData = async () => {
      ...
      if (dataRemove.ids.length > 0) {
        resRemove = (await axiosClient.delete(
          "https://apr-mentioned-accompanied-katrina.trycloudflare.com/api/v3/profiles-skills/remove",
          { data: dataRemove }
        )) as unknown as IData;
      }
