  ...
  const handleUpdateData = async () => {
    if (type === "add") {
      const res = (await axiosClient.put(
        "https://welcome-unlimited-summaries-formerly.trycloudflare.com/api/v1/profiles/exp/c",
        dataRequest
      ...
      const res = (await axiosClient.put(
        "https://welcome-unlimited-summaries-formerly.trycloudflare.com/api/v1/profiles/exp/u",
        dataRequest
      )) as unknown as IResquest;
      if (res && res.code === 200) {
